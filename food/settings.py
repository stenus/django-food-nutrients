...
try:
    ...
    input('Create private_config.py as decribed in README.md. Press Enter to exit')
...
SECRET_KEY = '4ghjjw)#!_y0+*gtrdda8zh3l8on+++^es@z8t#gpjg5rmbbb6'
...
DATABASES = {
    'default': {
        ...
        'NAME': private_config.db['name'],
        'USER': private_config.db['username'],
